...
add(new Paragraph({spacing:{after:220}, children:[new TextRun({
  text:"What data-driven relaxation of trial eligibility criteria can and cannot promise: an out-of-sample evaluation, and why no data requirement can be read from cohort size alone",
